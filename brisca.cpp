...
#else
    int color = 0; // Placeholder for Linux
#endif
...
#else
            cout << "\033[31m"; // Red color for Linux
#endif
            cout << "TUS CARTAS" << e;
#ifdef _WIN32
            SetConsoleTextAttribute(a.color, 7);
#else
            cout << "\033[0m"; // Reset color for Linux
#endif
            simbolos(b.cartasj);
        }
        if (a.jugador2 == true)
...
#else
                cout << "\033[34m"; // Blue color for Linux
#endif
                cout << "Tira una carta (Ingresando el # de la Izquiera)" << e;
#ifdef _WIN32
                SetConsoleTextAttribute(a.color, 7);
...
#else
            cout << "\033[33m"; // Yellow color for Linux
#endif
            cout << "MONEDA DE ORO" << " ^ ";
            numeros(x, i);
#ifdef _WIN32
...
#else
            cout << "\033[36m"; // Cyan color for Linux
#endif
            cout << "ESPADA" << " ^ ";
            numeros(x, i);
#ifdef _WIN32
...
#else
            cout << "\033[32m"; // Green color for Linux
#endif
            cout << "BASTON" << " ^ ";
            numeros(x, i);
#ifdef _WIN32
